...
--
-- Hôte : 127.0.0.1
-- Généré le : lun. 03 août 2020 à 17:16
...
--
ALTER TABLE `comments`
  ADD CONSTRAINT `comments_ibfk_1` FOREIGN KEY (`users_id`) REFERENCES `users` (`id`) ON UPDATE CASCADE,
  ADD CONSTRAINT `comments_ibfk_2` FOREIGN KEY (`articles_id`) REFERENCES `articles` (`id`);
COMMIT;
